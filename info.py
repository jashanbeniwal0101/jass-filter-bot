...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "1955406483").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "arsh_beniwal"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "https://t.me/arsh_beniwal")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002713648379").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002811433694"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002715451447"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002624060739"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1002685461345"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1002706219876"))
...
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://rs92573993688:pVf4EeDuRi2o92ex@cluster0.9u29q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "arsh_benwail")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-4846449034"))
...
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002474527052"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/arsh_beniwal")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+IrL05PO1_2E4YjQ1")

# Verification
IS_VERIFY = is_enabled("IS_VERIFY", True)
# ---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/allbotsupdates1/9")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/")
VERIFY_IMG = environ.get(
    "VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg"
)
SHORTENER_API = environ.get("SHORTENER_API", "270f93e02b9442a5ce7bce04d")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "pocolinks.in")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://i.ibb.co/HpfhPYWL/image.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://i.ibb.co/hrBBm3P/image.jpg")
).split()
SUBSCRIPTION = environ.get(
    "SUBSCRIPTION", "https://i.ibb.co/B2nFGvxB/image.jpg"
)
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
